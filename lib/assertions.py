...
class Assertions:
    ...
    @staticmethod
    def assert_content_decode(response: Response, expected_content):
        assert response.content.decode("utf-8") == f"{expected_content}", \
    ...
    @staticmethod
    def assert_decode_as_json(response: Response, name, expected_content, error_message):
        try:
        ...
        assert response_as_json == expected_content, error_message
